...
<section class="new-task">
    <div class="new-task__wrapper">
        ...
        foreach ($taskData as $id => $task) :?>
            <div class="new-task__card" data-id-task="$id">
                ...
                <b class="new-task__price new-task__price--<?= Html::encode($task['category']['icon']) ?>"><?= Html::encode($task['price']) ?><b> ₽</b></b>

                <p class="new-task__place"><?= Html::encode($task['location'])?:'&#160;' ?></p>

                <span class="new-task__time"><?= $task['dateCreate'] === 'now'? 'сейчас': $task['dateCreate'].' назад' ?></span>
            </div>
        <? endforeach; ?>
    </div>
