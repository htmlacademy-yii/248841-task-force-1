    ...
    <div class="user__card-wrapper">
        <div class="user__card">
            ...
            <div class="content-view__headline">
                ...
                <b class="done-task">Выполнил <?= WordHelper::getPluralWord($user->completedTasksCount, ['заказ', 'заказа', 'заказов']) ?></b><b
                        class="done-review">Получил <?= WordHelper::getPluralWord(count($user->responses), ['отзыв', 'отзыва', 'отзывов']) ?></b>
            </div>
