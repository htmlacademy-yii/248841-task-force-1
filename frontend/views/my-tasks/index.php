...
use frontend\assets\MyTaskAsset;
use frontend\widgets\StarsReviews;
use yii\bootstrap\Html;
use yii\data\ActiveDataProvider;
use yii\helpers\Url;

MyTaskAsset::register($this);
?>
<section class="menu-toggle">
    <ul class="menu-toggle__list">
        <li class="menu-toggle__item menu-toggle__item--completed">
            ...
            <a href="<?= Url::to(['my-tasks/index', 'status' => \Lobochkin\TaskForce\Task::STATUS_DONE]) ?>">
                Завершённые
            </a>
        </li>
        <li class="menu-toggle__item menu-toggle__item--new">
            <div class="menu-toggle__svg-wrapper">
        ...
        <li class="menu-toggle__item menu-toggle__item--active">
            ...
            <a href="<?= Url::to(['my-tasks/index', 'status' => \Lobochkin\TaskForce\Task::STATUS_IN_WORK]) ?>">
                Активные
            </a>
        </li>
        <li class="menu-toggle__item menu-toggle__item--canceled">
            ...
            <a href="<?= Url::to(['my-tasks/index', 'status' => \Lobochkin\TaskForce\Task::STATUS_CANCEL]) ?>">
                Отменённые
            </a>
        </li>
